  ...
  return (
    <div className="space-y-8 pb-96">
        ...
        {statsData.map((stat, index) => (
          ...
          >
            <div className="flex items-center">
              <div
                className={`flex-shrink-0 w-12 h-12 ${colorClasses[stat.color].bg
      ...
      {/* AI Insights Card */}
        <AIInsightsCard/>
      {/* AI Insights Card */}
      <div className="w-full bg-white border border-slate-200 rounded-lg shadow-lg shadow-sm shadow-gray-100 overflow-hidden">
